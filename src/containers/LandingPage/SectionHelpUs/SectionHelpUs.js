...
const Logo = props => (
  <svg
    ...
    width={246}
    height={58.927}
    viewBox="0 0 246 58.927"
    {...props}
  >
    <defs>
      <clipPath id="a">
        <path fill="#fff" d="M0 58.926h246V0H0Z" data-name="Path 26" />
      </clipPath>
    </defs>
    <g data-name="Group 447">
      <g data-name="Group 1">
        <path fill="#fff" d="M84.048 52.29h4.259V16.825l-4.259-2.317Z" data-name="Path 6" />
      </g>
      <g data-name="Group 2">
        <path fill="#fff" d="M35.019 52.29h4.26V9.849l-4.26 2.317Z" data-name="Path 7" />
      </g>
      <g data-name="Group 3">
        <path fill="#fff" d="M77.044 52.29h4.259V13.019l-4.259-2.322Z" data-name="Path 8" />
      </g>
      <g data-name="Group 4">
        <path fill="#fff" d="m74.302 9.204-4.26-2.317v22.08h4.26Z" data-name="Path 9" />
      </g>
      <g data-name="Group 5">
        <path fill="#fff" d="m57.382 0-1.35.736v28.23h4.259V1.583Z" data-name="Path 10" />
      </g>
      <g data-name="Group 6">
        <path fill="#fff" d="M28.015 52.291h4.26V13.66l-4.26 2.318Z" data-name="Path 11" />
      </g>
      <g data-name="Group 7">
        <path fill="#fff" d="m67.297 5.393-4.26-2.317v25.891h4.26Z" data-name="Path 12" />
      </g>
      <g data-name="Group 8">
        <path fill="#fff" d="M7.003 52.291h4.26V20.318l-4.26.846Z" data-name="Path 13" />
      </g>
      <g data-name="Group 9">
        <path fill="#fff" d="M14.008 52.291h4.26V18.926l-4.26.846Z" data-name="Path 14" />
      </g>
      <g data-name="Group 10">
        <path fill="#fff" d="M21.012 18.381V52.29h4.259V17.467l-.186.1Z" data-name="Path 15" />
      </g>
      <g data-name="Group 11">
        <path fill="#fff" d="M0 22.555v29.736h4.259V21.709Z" data-name="Path 16" />
      </g>
      <g data-name="Group 12">
        <path fill="#fff" d="M49.027 52.291h4.26V2.228l-4.26 2.317Z" data-name="Path 17" />
      </g>
      <g data-name="Group 13">
        <path fill="#fff" d="M42.024 52.29h4.259V6.038l-4.259 2.321Z" data-name="Path 18" />
      </g>

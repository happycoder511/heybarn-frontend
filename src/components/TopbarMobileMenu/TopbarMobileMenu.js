  ...
  return (
    <div className={css.root}>
      ...
      <div className={css.content}>
        ...
        <NamedLink
          className={classNames(css.navigationLink, currentPageClass('NewAdvertPage'))}
          name="NewAdvertPage"
        >
          <FormattedMessage id="TopbarMobileMenu.createAdvertLink" />
        </NamedLink>
        ...
        <NamedLink
          className={classNames(css.navigationLink, currentPageClass('ManageAdvertsPage'))}
          name="ManageAdvertsPage"
        >
          <FormattedMessage id="TopbarMobileMenu.yourAdvertsLink" />
        </NamedLink>
        <NamedLink

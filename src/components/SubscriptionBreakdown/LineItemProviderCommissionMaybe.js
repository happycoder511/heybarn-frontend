...
const LineItemProviderCommissionMaybe = props => {
  ...
  // If you are not using provider commisison you might want to remove this whole component from SubscriptionBreakdown.js file.
    ...
    commissionItem = (
      <div className={css.lineItem}>
        <span className={css.itemLabel}>
          <FormattedMessage id="SubscriptionBreakdown.commission" />
        </span>

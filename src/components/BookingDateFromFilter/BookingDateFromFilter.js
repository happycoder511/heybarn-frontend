...
import { FieldDateRangeController, FieldDateInput, FilterPopup, FilterPlain } from '..';
import css from './BookingDateFromFilter.module.css';
...
export class BookingDateFromFilterComponent extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const labelForPlain = isSelected
      ? intl.formatMessage(
          { id: 'BookingDateFromFilter.labelSelectedPlain' },
          {
      ...
      : label
      ? label
      : intl.formatMessage({ id: 'BookingDateFromFilter.labelPlain' });

    const labelForPopup = isSelected
      ? intl.formatMessage(
          { id: 'BookingDateFromFilter.labelSelectedPopup' },
          {
            dates: `${formattedStartDate} - ${formattedEndDate}`,
          }
        )
...
BookingDateFromFilterComponent.defaultProps = {
  rootClassName: null,
  className: null,
  showAsPopup: true,
  liveEdit: false,
...
BookingDateFromFilterComponent.propTypes = {
...
const BookingDateFromFilter = injectIntl(BookingDateFromFilterComponent);

export default BookingDateFromFilter;
